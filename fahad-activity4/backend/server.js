...
// const url = "mongodb+srv://fahadbajwa1149:1234@cluster0.zdtpb.mongodb.net/";
...
const url = process.env.MONGODB_URI || "mongodb+srv://fahadbajwa1149:1234@cluster0.zdtpb.mongodb.net/";
mongoose.connect(url, {
    useNewUrlParser: true,
    useCreateIndex: true,
    useUnifiedTopology: true
